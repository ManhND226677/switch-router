...
const REMOVED_LIST = [
  ...
  "gemini-cli",
  // NOTE: "qwen" (registry, OAuth Qwen Code) was retired but stays OFF this
  // list — "qwen" is still a live THINKING FORMAT (thinkingFormat: "qwen" in
  // capabilities.js) so tests legitimately reference it as a format name.
  "qoder",
  "ollama-local",
  "mimo-free",
  "mmf",
