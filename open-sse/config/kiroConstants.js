 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Switch-Router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are Switch-Router
...
/**
 * Detect whether a model id refers to a Switch-Router synthetic agentic variant.
...
/**
 * Detect whether a model id is a Switch-Router synthetic thinking variant
...
/**
 * Resolve a Switch-Router model id to the real upstream Kiro model id, plus flags
