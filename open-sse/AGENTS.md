...
- Translator pipeline pivots through OpenAI as the intermediate format. A translator registered on the exact `source:target` pair runs as a **direct route**, skipping the lossy double-hop.
