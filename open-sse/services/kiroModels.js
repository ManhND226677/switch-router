 ...
 * into Switch-Router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are Switch-Router synthetic ids and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic Switch-Router variant set for a single upstream Kiro model.
 *
 ...
 * into Switch-Router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
