 ...
 *
 * The gateway is chat/LLM-only: media capabilities (tts/stt/embedding/image/search) are
 * not supported anymore — do not add *Config keys or media serviceKinds.
 */
...
export default {
  ...
  // ── media (service kinds) → PROVIDER_MEDIA[id] ────────────────────────────
  // media: {
  //   serviceKinds: ["llm"],
  //   // hiddenKinds: [],
  // },
