...
export const PROVIDER_CAPABILITIES = {
  ...
  "workbuddy": {
    ...
    "glm-5.3-flash": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 200000, maxOutput: 64000 },
    "glm-5.2": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 48000 },
    "glm-5.1": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 48000 },
    "glm-5v-turbo": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 200000, maxOutput: 64000 },
    "kimi-k3": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 32000 },
    "kimi-k2.7-code": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 64000 },
    ...
    "minimax-m2.7": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 512000, maxOutput: 128000 },
    "deepseek-v4-flash": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 384000 },
    "deepseek-v4-pro": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 384000 },
    "deepseek-v4.1-flash": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 384000 },
  },
  // Novita's live /models response is authoritative for the account's model
  // list. These entries only pin the capabilities documented for the static
  // fallback; unknown live IDs still receive family-pattern fallbacks below.
  "novita": {
    "qwen/qwen3.8-flash": { vision: true, reasoning: true, thinkingFormat: "qwen", contextWindow: 977000, maxOutput: 128000 },
    "qwen/qwen3.8-max": { vision: true, reasoning: true, thinkingFormat: "qwen", contextWindow: 1000000, maxOutput: 64000 },
    "deepseek/deepseek-v4-flash": { vision: true, reasoning: true, thinkingFormat: "deepseek", contextWindow: 1000000, maxOutput: 384000 },
    "deepseek/deepseek-v4-pro": { vision: true, reasoning: true, thinkingFormat: "deepseek", contextWindow: 1000000, maxOutput: 384000 },
    "deepseek/deepseek-v4-pro-0813": { vision: true, reasoning: true, thinkingFormat: "deepseek", contextWindow: 1000000, maxOutput: 384000 },
    "zai-org/glm-5.3-flash": { vision: true, reasoning: true, thinkingFormat: "zai", contextWindow: 200000, maxOutput: 64000 },
    "zai-org/glm-5.3": { vision: true, reasoning: true, thinkingFormat: "zai", contextWindow: 1000000, maxOutput: 128000 },
    "moonshotai/kimi-k3": { vision: true, reasoning: true, thinkingFormat: "kimi", contextWindow: 1000000, maxOutput: 128000 },
    "moonshotai/kimi-k2.7-code": { vision: true, reasoning: true, thinkingFormat: "kimi", contextWindow: 1000000, maxOutput: 128000 },
    "tencent/hy3": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 192000, maxOutput: 64000 },
  },
