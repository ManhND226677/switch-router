...
describe("detectRequiredCapabilities", () => {
  ...
  it("web_search tool -> no search while auto-switch search is disabled", () => {
    // Search detection is intentionally disabled in the engine (combo.js: "search:
    // temporarily disabled in auto-switch") — the tool list is not scanned yet.
