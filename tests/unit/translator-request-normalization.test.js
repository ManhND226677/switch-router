...
describe("request normalization", () => {
  it("claudeToOpenAIRequest preserves multiple text blocks as OpenAI content parts", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("filterToOpenAIFormat preserves multiple text parts", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("parseSSELine supports raw NDJSON stream lines when the provider format is Ollama", () => {
