// #2069 — cache_control markers stripped for the Alibaba Intl DashScope provider.
...
describe("filterToOpenAIFormat cache_control handling (#2069)", () => {
  ...
  it("preserves cache_control when preserveCacheControl option is true (DashScope)", () => {
    const body = { messages: JSON.parse(JSON.stringify(msgWithCache)) };
