...
export async function GET() {
  try {
    const cachePath = join(getRuntimeHomeDir(), ".aws/sso/cache");
    ...
    const kiroProfilePaths = [
      join(process.env.APPDATA || join(getRuntimeHomeDir(), "AppData", "Roaming"), "Kiro", "User", "globalStorage", "kiro.kiroagent", "profile.json"),
      join(getRuntimeHomeDir(), ".config", "Kiro", "User", "globalStorage", "kiro.kiroagent", "profile.json"),
    ];
