...
export async function GET(request, { params }) {
  ...
  const response = await fetch(`${stepFunEndpoint("files", context.credentials)}/${id}/content`, {
    method: "GET",
    headers: stepFunHeaders(context.credentials, { Accept: "text/plain, application/json" }),
  });
