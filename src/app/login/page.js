...
export default function LoginPage() {
  ...
  // Force a new password before entering the dashboard when legacy auth is used.
    ...
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary mb-2">Switch-Router</h1>
          ...
          {mustChange ? (
            <form onSubmit={handleSetNewPassword} className="flex flex-col gap-4">
              <p className="text-sm text-amber-600 dark:text-amber-400 text-center">
                Set a new password before accessing the dashboard.
              </p>
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-4">
                ...
                {hasPassword === false && (
                  <p className="text-xs text-center text-amber-600 dark:text-amber-400">
                    Dashboard password is not configured. Local mode remains available on this machine.
                  </p>
                )}
              </form>
            ) : (
