...
export default function ModelSelectModal({
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- refresh combos when the modal opens; state updates only after the response resolves
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- refresh provider nodes when the modal opens; state updates only after the response resolves
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- refresh custom models when the modal opens; state updates only after the response resolves
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- refresh disabled models when the modal opens; state updates only after the response resolves
