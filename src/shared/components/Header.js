...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/skills"))
    return {
      title: "Agent Skills",
      description: "Copy a link and paste to your AI to use Switch-Router — no install needed",
      icon: "extension",
      breadcrumbs: [],
    };
...
function HeaderSearch() {
  ...
  return (
    <div className="relative w-[160px] sm:w-[220px]">
      <span className="material-symbols-outlined absolute left-2 top-1/2 -translate-y-1/2 text-text-muted text-base pointer-events-none">
        search
      </span>
      <input
        type="text"
