...
// Same PATH extension trick as the optional token-saver runtimes: packaged/launchd environments
...
async function runInstall() {
  ...
  if (!fs.existsSync(pkgJson)) {
    fs.writeFileSync(pkgJson, JSON.stringify({ name: "switch-router-pxpipe-host", private: true }, null, 2));
  }
