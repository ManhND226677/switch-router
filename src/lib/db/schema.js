...
export const TABLES = {
  ...
  apiKeys: {
    columns: {
      ...
      machineId: "TEXT",
      isActive: "INTEGER DEFAULT 1",
      // Internal keys used by model probes are hidden from dashboard lists.
      isHidden: "INTEGER DEFAULT 0",
      createdAt: "TEXT NOT NULL",
      // Per-key policy (migration 004). Must stay declared here too:
      // syncSchemaFromTables can only self-heal columns listed in TABLES.
      allowedModels: "TEXT",
